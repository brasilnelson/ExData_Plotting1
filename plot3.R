...
with(tbl, plot(Sub_metering_1~DateTime, type='l', ylab='Energy Sub metering', xlab=''))
with(tbl, lines(Sub_metering_2~DateTime, type='l', col='red'))
with(tbl, lines(Sub_metering_3~DateTime, type='l', col='blue'))
